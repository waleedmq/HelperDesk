...
public class PLanguageService {
	...
	public List<ProgrammingLanguage> getAllPLanguages(){
		return pLanguageRepo.findAll();
	}
	
	
	public Optional<ProgrammingLanguage> findLanguagebyName(Long id) {
		return pLanguageRepo.findById(id);
	}
